...
- `LLM_SYSTEM`: System prompt (default: `You are a helpful assistant.`)
- `LLM_PREPROMPT`: Preprompt used before each transcript (default: `Use the following transcription to respond conversationally.`)
- `LLM_POSTPROMPT`: Optional postprompt (default: empty)
